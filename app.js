      ...
      <div className="container">
        {!effectiveData ? (
          ...
          <>
            ...
            {/* --- 3. 디자인 및 구조가 개선된 그룹 탭 영역 (한 줄 통합 & 삭제 버튼 변경) --- */}
            {activeTab === "group" && (
